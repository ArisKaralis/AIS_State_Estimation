...
ekf.StateCovariance = diag([pos_std^2, vel_std^2, pos_std^2, vel_std^2]);
...
function H = measurementJacobianFcn(x)
    ...
    if speed > 0.01
        ...
        H(4, 2) = -vy / denominator;
        H(4, 4) = vx / denominator;
    else
        H(3, 2) = 1;
        H(3, 4) = 0;
        H(4, 2) = 0;
